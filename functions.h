...
void collisionAvoidance()
{
  ...
  { //Watch if something is around every LPT loops while moving forward 
    ...
    else if(obstacle_sign=="11100" || obstacle_sign=="01000" || obstacle_sign=="11000"  || obstacle_sign=="10100"  || obstacle_sign=="01100" ||obstacle_sign=="00100"  ||obstacle_sign=="01000") // turn right
    {
    ...
    else if(obstacle_sign=="01111" ||  obstacle_sign=="10111" || obstacle_sign=="11110" ||  obstacle_sign=="11101" || obstacle_sign=="11011" || obstacle_sign=="01110") // go back
    {
    ...
    else if(obstacle_sign=="11111") // turn around
    {
      Serial.println("Turn Around");
      turnRight(180);
      set_Motorspeed( 300,300);
      pause(backtime);
      stop();
    }    
  ...
  else 
  {
    ...
    set_Motorspeed(SPEED,SPEED);
    goForward();  // if nothing is wrong go forward using go() function above.
    pause(backtime);
    stop();
  }
